import { c as create_ssr_component, b as compute_rest_props, f as spread, h as escape_object, g as escape_attribute_value, d as add_attribute, v as validate_component, e as escape } from "./ssr.js";
...
const LoadingBanner = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { show = true } = $$props;
  let { loadingMsg = "Loading..." } = $$props;
  if ($$props.show === void 0 && $$bindings.show && show !== void 0) $$bindings.show(show);
  if ($$props.loadingMsg === void 0 && $$bindings.loadingMsg && loadingMsg !== void 0) $$bindings.loadingMsg(loadingMsg);
  return `${show ? `<div class="flex justify-center"><div class="fixed top-6 bg-gray-900 rounded-lg opacity-90 z-10">${validate_component(Spinner, "Spinner").$$render($$result, { class: "m-4" }, {}, {})} <span class="dark:text-white mr-4">${escape(loadingMsg)}</span></div></div>` : ``}`;
});
export {
  LoadingBanner as L
};
