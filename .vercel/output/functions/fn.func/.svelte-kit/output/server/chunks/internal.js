...
const options = {
  ...
  templates: {
    app: ({ head, body, assets: assets2, nonce, env }) => '<!doctype html>\n<html class="dark" lang="en">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="' + assets2 + '/favicon.ico" sizes="48x48" />\n		<link rel="icon" href="' + assets2 + '/favicon.svg" sizes="any" type="image/svg+xml" />\n		<link rel="apple-touch-icon" href="' + assets2 + `/apple-touch-icon-180x180.png" />
		...
		<script
			...
			data-cf-beacon='{"token": "5881df6e20ae4fac839a45e7e02e2567"}'
		><\/script>
